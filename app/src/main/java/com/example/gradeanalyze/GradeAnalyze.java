...
public class GradeAnalyze extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sc4.setText(scr4str);
            ...
            float gpa1, gpa2, gpa3, gpa4;//绩点
            gpa1 = ee1 / 10 - 5;
            gpa2 = ee2 / 10 - 5;
            gpa3 = ee3 / 10 - 5;
            gpa4 = ee4 / 10 - 5;
        //绩点
        BigDecimal gpaturn1 = new BigDecimal(gpa1);
        float gpa1Final = gpaturn1.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
        gp1.setText(""+gpa1Final);//四舍五入、保留两位小数

        BigDecimal gpaturn2 = new BigDecimal(gpa2);
        float gpa2Final = gpaturn2.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
        gp2.setText(""+gpa2Final);

        BigDecimal gpaturn3 = new BigDecimal(gpa3);
        float gpa3Final = gpaturn3.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
        gp3.setText(""+gpa3Final);

        BigDecimal gpaturn4 = new BigDecimal(gpa4);
        float gpa4Final = gpaturn4.setScale(2, BigDecimal.ROUND_HALF_UP).floatValue();
        gp4.setText(""+gpa4Final);
            int tscr;//总学分
            tscr = eg1 + eg2 + eg3 + eg4;
            tsc.setText(""+tscr);
            float tgpa;//总绩点
            tgpa = (gpa1 + gpa2 + gpa3 + gpa4) / 4;
